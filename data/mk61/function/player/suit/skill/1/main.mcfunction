...
#파티클
particle minecraft:flame ~ ~ ~ .1 .1 .1 0 6 force @a
...
$execute if score %range prd.num matches 1.. positioned ^ ^ ^0.5 if block ~ ~ ~ #air run function mk61:player/suit/skill/1/main {damage:$(damage),id:$(id)}
