execute anchored eyes run summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,Marker:1b,active_effects:[{id:"invisibility",duration:100000,show_particles:false}],Tags:[prd.ironman.missile,prd.entity],ArmorItems:[{},{},{},{id:"minecraft:iron_block",count:1b}],Small:1b}
...
scoreboard players set @e[tag=prd.ironman.missile,tag=!imID] prd.ironman.flyspeed 7
