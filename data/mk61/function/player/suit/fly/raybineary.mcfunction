execute if score #prd.this2 prd.ironman.flyspeed matches 8.. at @s unless block ^ ^ ^1.6 #air as @e[tag=prd.player.this] run return run function mk61:player/suit/fly/unfly
...
execute if score #prd.this2 prd.ironman.flyspeed matches 4.. at @s unless block ^ ^ ^0.8 #air as @e[tag=prd.player.this] run return run function mk61:player/suit/fly/unfly
...
execute if score #prd.this2 prd.ironman.flyspeed matches 2.. at @s unless block ^ ^ ^0.4 #air as @e[tag=prd.player.this] run return run function mk61:player/suit/fly/unfly
...
execute if score #prd.this2 prd.ironman.flyspeed matches 1.. at @s unless block ^ ^ ^0.2 #air as @e[tag=prd..this] run return run function mk61:player/suit/fly/unfly
