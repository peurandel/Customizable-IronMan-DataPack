...
$data modify block ~ ~ ~ Items[-1].components.minecraft:custom_name set from storage prd:suit table.tech.'$(id)'.text
data remove entity @s data.this.suit[0]
function mk61:beacon.table/page/tech/get_tech with entity @s data.this.suit[0]