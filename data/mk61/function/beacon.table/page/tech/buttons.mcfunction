...
execute if score .button prd.ui matches 1 run function mk61:beacon.table/page/tech/back
execute if score .button prd.ui matches 2 run scoreboard players set @s prd.ironman.beacon.editor.page 1

execute unless score @s prd.ironman.beacon.editor.page matches 2 run scoreboard players set .page_change prd.ui 1
execute unless score @s prd.ironman.beacon.editor.page matches 2 run function mk61:beacon.table/ui/refresh