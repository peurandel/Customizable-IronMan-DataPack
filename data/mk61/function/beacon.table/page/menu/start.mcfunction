...
execute if score .page_change prd.ui matches 0 run function mk61:beacon.table/page/menu/buttons

## apply mask of the ui shape -> if you are still on the same page!
execute if score @s prd.ironman.beacon.editor.page matches 1 run function mk61:beacon.table/page/menu/mask
