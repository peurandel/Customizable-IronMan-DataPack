...
item replace block ~ ~ ~ container.2 with diamond_sword[custom_name='{"text":"BACK TO SKILL","color":"dark_purple"}',minecraft:custom_data={ui_item:{}}]
...
#get skills
$data modify entity @s data.this.suit set from entity @s data.suit.minecraft:custom_data.data.skill[$(subnum)]
function mk61:beacon.table/page/skillslot/get_skill with entity @s data.this.suit[0]