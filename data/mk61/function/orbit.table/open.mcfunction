...
summon item_display ~ ~ ~ {view_range:0,width:0f,height:0f,teleport_duration:0,Tags:["prd.ui","new"],Passengers:[{id:"minecraft:chest_minecart",Invulnerable:1b,Tags:[prd.ui,new,prd.entity],CustomDisplayTile:1b,DisplayState:{Name:"minecraft:air"},Passengers:[{id:"minecraft:marker",Tags:[prd.ui,new]}]}]}
